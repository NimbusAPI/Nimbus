...
Nimbus is provided as-is under [An MIT License](LICENSE.md). Community support is best-effort when maintainers have time.
...
_Nimbus is maintained by volunteers who use it in production. We share it because we think it's useful. We're happy to help where we can, but this is not a commercial support contract._
