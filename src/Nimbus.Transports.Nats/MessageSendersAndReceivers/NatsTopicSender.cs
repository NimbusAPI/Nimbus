...
{
    internal class NatsTopicSender : INimbusMessageSender
    {
        private readonly string _topicPath;
        private readonly NatsConnectionFactory _connectionFactory;
        private readonly ISerializer _serializer;

        public NatsTopicSender(string topicPath, NatsConnectionFactory connectionFactory, ISerializer serializer)
        {
