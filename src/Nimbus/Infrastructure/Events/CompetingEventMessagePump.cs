...
namespace Nimbus.Infrastructure.Events
{
    public class CompetingEventMessagePump : MessagePump
    {
        ...
        public CompetingEventMessagePump(MessagingFactory messagingFactory, ICompetingEventBroker multicastEventBroker, Type eventType, string subscriptionName, ILogger logger, int batchSize)
