...
using Nimbus.UnitTests.DependencyResolverTests.MulticastEventHandlerResolutionTests.Handlers;
...
namespace Nimbus.UnitTests.DependencyResolverTests.MulticastEventHandlerResolutionTests
{
    [TestFixture]
