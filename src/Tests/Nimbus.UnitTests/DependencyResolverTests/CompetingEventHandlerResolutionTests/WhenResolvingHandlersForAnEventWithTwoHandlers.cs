...
using Nimbus.UnitTests.DependencyResolverTests.CompetingEventHandlerResolutionTests.Handlers;
...
namespace Nimbus.UnitTests.DependencyResolverTests.CompetingEventHandlerResolutionTests
{
    [TestFixture]
