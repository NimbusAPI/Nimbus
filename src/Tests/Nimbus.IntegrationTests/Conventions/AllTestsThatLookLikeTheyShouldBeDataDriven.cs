...
namespace Nimbus.IntegrationTests.Conventions
{
    ...
    public class AllTestsThatLookLikeTheyShouldBeDataDriven
    {
        ...
        public async Task ShouldHaveTestCaseSourceAttributes(MethodInfo testMethod)
        {
        ...
        [Test]
        [TestCaseSource(typeof (TestCases))]
        public async Task ShouldTakeATestHarnessBusFactoryAsAParameter(MethodInfo testMethod)
        {
