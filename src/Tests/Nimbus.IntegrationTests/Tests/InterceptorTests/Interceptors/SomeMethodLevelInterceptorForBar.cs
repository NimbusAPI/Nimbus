...
namespace Nimbus.IntegrationTests.Tests.InterceptorTests.Interceptors
{
    public class SomeMethodLevelInterceptorForBar : InboundInterceptor
    {
        ...
        {
            MethodCallCounter.RecordCall<SomeMethodLevelInterceptorForBar>(h => h.OnCommandHandlerSuccess(busCommand, nimbusMessage));
        }
        ...
        {
            MethodCallCounter.RecordCall<SomeMethodLevelInterceptorForBar>(h => h.OnCommandHandlerError(busCommand, nimbusMessage, exception));
        }
    }
}