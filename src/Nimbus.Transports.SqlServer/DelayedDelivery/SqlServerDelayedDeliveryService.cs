...
namespace Nimbus.Transports.SqlServer.DelayedDelivery
{
    internal class SqlServerDelayedDeliveryService : IDelayedDeliveryService
    {
        private readonly INimbusTransport _transport;
        private readonly ILogger _logger;

        public SqlServerDelayedDeliveryService(INimbusTransport transport, ILogger logger)
        {
